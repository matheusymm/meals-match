...
public class RecipeService implements IRecipeService {
    ...
    public RecipeDTO createRecipe(RecipeDTO recipeDTO) {
        ...
        System.getLogger("RecipeService").log(System.Logger.Level.INFO, "Creating recipe: " + recipeDTO.name());
        ...
        return new RecipeDTO(recipe.getId(), recipe.getName(), recipe.getAuthor().getId(),
                ...
                recipe.getRating(), recipe.getIngredients(), recipe.getCategories(), recipe.getComments());
    }
